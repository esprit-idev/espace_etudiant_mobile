 ...
 * @author eslem
 */
public class NewsCategoryAdd extends Form{
    public NewsCategoryAdd(){
        Toolbar tb = getToolbar();
        setLayout(new FlowLayout(CENTER, CENTER));
        setTitle("Ajouter une Categorie de News");
        ...
        add_btn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (tfcategoryName.getText().isEmpty()) {
                    ...
                    //create new doc
                    CategoryNews cat = new CategoryNews(tfcategoryName.getText());
                    if (ServiceCategoryNews.getInstance().addCategory(cat)) {
                        //success toast
