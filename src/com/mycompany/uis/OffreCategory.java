 ...
 * @author eslem
 */
public class OffreCategory extends Form{
    ...
    private void initGuiBuilderComponents(Resources resourceObjectInstance, ArrayList<CategoryEmploi> categories, Form previous) {
