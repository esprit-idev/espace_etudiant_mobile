...
public class NewsSheet extends Sheet{
        ...
        //category news sheet
       public NewsSheet(Sheet parent, CategoryNews cat, Form previous) {
       super(parent, "");
        setUIID("CustomSheet");
        int id = cat.getId();
        ...
        supp_btn.addActionListener(e -> {
            ...
            s_confirm_btn.setFont(poppinsRegular);
            confirm_btn.addActionListener(e2 -> {
                if (ServiceCategoryNews.getInstance().deleteCategory(id)) {
       ...
       //offre 
        ...
        //categorie offre
        public NewsSheet(Sheet parent, CategoryEmploi cat, Form previous) {
        super(parent, "");
        setUIID("CustomSheet");
        int id = cat.getId();
