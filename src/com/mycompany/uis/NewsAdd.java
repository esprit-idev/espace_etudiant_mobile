...
public class NewsAdd extends Form {
    public NewsAdd(Resources res){
        ...
        TextField tfauth = new TextField("", "author");
        ...
        cnt.addAll(title,tftitle,auteur, tfauth,lDesc, tfDesc, lcat, cbCat, add_image,add_btn);
        add(cnt);
        //date 
           ...
           if ( imgFile.lastIndexOf(".") > 0) {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (tftitle.getText().isEmpty() || tfDesc.getText().isEmpty() || tfauth.getText().isEmpty() || namePic.isEmpty()) {
                    ...
                    if (ServicePublicationNews.getInstance().addPublication(pub)) {
                        //success toast
